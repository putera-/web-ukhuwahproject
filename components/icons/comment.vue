        ...
        <g id="SVGRepo_iconCarrier">
            <g clip-path="url(#clip0_901_2831)">
                <path
                    ...
                    fill="#FFC44D"></path>
                <path
                    d="M22 11.9902C22.55 11.9902 23 12.4402 23 12.9902C23 13.5402 22.55 13.9902 22 13.9902C21.45 13.9902 21 13.5402 21 12.9902C21 12.4402 21.45 11.9902 22 11.9902ZM16 12C16.55 12 17 12.45 17 13C17 13.55 16.55 14 16 14C15.45 14 15 13.55 15 13C15 12.45 15.45 12 16 12ZM10 12C10.55 12 11 12.45 11 13C11 13.55 10.55 14 10 14C9.45 14 9 13.55 9 13C9 12.45 9.45 12 10 12Z"
                    fill="#FFE6EA"></path>
                <path
