    ...
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_iconCarrier">
            <g clip-path="url(#clip0_901_2831)">
                <path
                    d="M24 25.0002H2C1.45 25.0002 1 24.5502 1 24.0002V2.00024C1 1.45024 1.45 1.00024 2 1.00024H30C30.55 1.00024 31 1.45024 31 2.00024V30.0002C31 31.0002 30.61 31.6102 29 30.0002L24 25.0002Z"
                    fill="#fff"></path>
                <path
