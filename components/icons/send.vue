<template>
    <svg fill="#000000" viewBox="0 0 24 24" id="send" xmlns="http://www.w3.org/2000/svg" class="icon multi-color">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <title style="stroke-width:1.056;">send</title>
            <path id="secondary-fill"
                ...
                style="fill: #F1AE6D; stroke-width:1.056;"></path>
            <path id="primary-stroke"
                ...
                style="fill: none; stroke: #000000; stroke-linecap: round; stroke-linejoin: round; stroke-width:1.056;">
            </path>
        </g>
    </svg>
</template>